  ...
  return (
    <>
      ...
      <svg
        ...
        height="384"
        fill="none"
        viewBox="0 0 1728 384"
      >
        <g clip-path="url(#a)">
          <path fill="#09F" d="m0 38.4 1728 230.4V384H0V38.4Z" />
        </g>
        <defs>
          <clipPath id="a">
            <path fill="#fff" d="M0 0h1728v384H0z" />
          </clipPath>
        </defs>
      </svg>
      <div>
      ...
      <svg
        ...
        height="355"
        fill="none"
        viewBox="0 0 1728 355"
      >
        <path fill="#09F" d="m0 40.8 1836 244.8V0H0v40.8Z" />
      </svg>
    </>
  );
}
